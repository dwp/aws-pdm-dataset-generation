...
#TODO rename this step file to something appropriate. The below code now lives in ADG. the ERM-LAUNCHER will need to pass the above vars to whatever this step name will be
