...
hive -e "CREATE EXTERNAL TABLE IF NOT EXISTS data_pipeline_metadata_hive (Correlation_Id STRING, Run_Id BIGINT, DataProduct STRING, DateProductRun STRING, Status STRING) \
