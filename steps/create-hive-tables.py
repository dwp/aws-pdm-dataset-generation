...
DatabaseName = "pdm_dataset_generation_staging"
...
for collection in collections_hbase:
    if collection in hbase_tables:
        ...
        try:
            client.delete_table(DatabaseName=DatabaseName,
        ...
        try:
            client.create_table(
                ...
                TableInput={
                    ...
                    "StorageDescriptor": {
                        ...
                        "Location": "s3://${bucket}/pdm-dataset/hive/external/"
                        + collection_staging,
                        "Compressed": False,
                        "NumberOfBuckets": -1,
                        "SerdeInfo": {
            ...
            the_logger.error(
                "Exception cannot create table: " +
                collection_hbase + " " + str(e)
            )
    else:
